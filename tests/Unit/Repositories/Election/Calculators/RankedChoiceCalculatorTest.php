...
use App\Repositories\Election\Calculators\RankedChoiceCalculator;

//use PHPUnit\Framework\TestCase;
use Tests\TestCase;


class RankedChoiceCalculatorTest extends TestCase
{
...
//        }
//
//        $this->object = new RankedChoiceCalculator($this->motion);
//
//        //check
//        for ($i = 0; $i < sizeof($totals); $i++) {
