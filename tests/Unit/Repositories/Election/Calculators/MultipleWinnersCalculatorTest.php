...
//        $this->assertTrue($this->object->isRoomInWinners(collect($r)), "returns true when room and given collection");
    ...
    // ================================= VOT-258
    /** @test
     This calculator was not implicated in the bug which led to
     this issue but checking just in case */
    public function VOT258_allParticipantsNeedRunoffAndAllButOneHasSameScore(){
        ...
        $this->candidate4 = Candidate::factory()->create(['motion_id' => $this->motion->id]);
        ...
        //check
        $this->assertTrue($this->object->isWinner($this->winner), "Correctly identifies winner ");
        ...
        $this->assertFalse($this->object->isRunoffParticipant($this->winner), "Correctly identifies not in runoff ");
        ...
        $this->assertTrue($this->object->isRunoffParticipant($this->candidate4), "Correctly identifies runoff");
